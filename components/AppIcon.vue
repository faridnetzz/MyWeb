...
/**
 * One stroke-based icon set, 24×24, inherits colour + size from `.icon`.
 * Markup is authored here and never user-supplied, so v-html is safe.
 */
...
const icons: Record<string, string> = {
  ...
  award: '<circle cx="12" cy="8" r="6"/><path d="m8.2 13.1-1.4 8L12 18l5.2 3.1-1.4-8"/>',
